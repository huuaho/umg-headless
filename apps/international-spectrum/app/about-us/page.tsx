    ...
    <main className="min-h-screen bg-white">
      <section className="max-w-280 mx-auto px-6 py-12 md:py-16">
        ...
        <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto leading-relaxed">
          International Spectrum Media explores the richness of global cultures,
          sharing stories and experiences that promote cross-cultural
          understanding. As part of the United Media Group network, we celebrate
          diversity and build bridges between communities worldwide.
        </p>
      </section>
