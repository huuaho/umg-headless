...
| [about-us/](about-us/README.md) | folder | About page: AEO-structured (H1 = org name, pillar H2s, mission sentence) + FAQ schema; competition promo section commented out. |
...
graph LR
  ...
  admin["admin/"] --> auth
  admin --> judging["lib/judging/*"]
  admin --> comp
  judging -.REST /wp-json/umg/v1/admin.-> plugin
