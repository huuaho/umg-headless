...
## Key exports
- `SectionType3(props)` (default) — `SectionData` fields plus `slug`, `category`, `noLabelLink?` (render the [CategoryLabel](CategoryLabel.tsx.md) unlinked), category-label styling props, `titleClassName`.
