...
## Dependencies
- Internal: [includes/config.php](includes/config.php.md), [includes/cors.php](includes/cors.php.md), [includes/post-types.php](includes/post-types.php.md), [includes/jwt.php](includes/jwt.php.md), [includes/auth.php](includes/auth.php.md), [includes/payment.php](includes/payment.php.md), [includes/draft.php](includes/draft.php.md), [includes/submission.php](includes/submission.php.md), [includes/school.php](includes/school.php.md), [includes/cleanup.php](includes/cleanup.php.md)
