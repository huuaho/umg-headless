...
- **Admin:** UM Articles → Ingestor Control (`um-ingestor-control`) with manual/continuous/server backfill, incremental runs, source-category re-sync (blank slug = whole site, 500 posts/click), settings, image refresh, and delete-all.
